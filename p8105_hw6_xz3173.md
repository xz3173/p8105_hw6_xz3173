...
distribution of `log_beta_product` is a left-skewed (or negatively
skewed) pattern. This skewness is characterized by a longer tail
extending towards lower values, with the majority of the data points and
the median skewed towards the right. The median of the distribution is
